For Spatial filters.cpp:
The code is self sufficient, just we need to specify the input image folder location as argument and need to specify folder name in code in line 12 and 13. 
